...
//
//   Filename: AdminEvents.jsp
//   Generated with CodeCharge  v.1.2.0
//   JSP.ccp build 05/21/01
//

static final String sFileName = "AdminEvents.jsp";
...
<html>
<head>
<title>SVEC - Event Administration</title>
...
<%!
  ...
  void Search_Show (javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sSearchErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    try {
      ...
      out.println("     <form method=\"get\" action=\"AdminEvents.jsp\" name=\"Search\">\n     <tr>");
      ...
      out.println("      <td style=\"background-color: #FFCC66; border-style: inset; border-width: 1\"><font style=\"font-size: 10pt; color: #000000\">Event</font></td>");
 ...
 out.println("</td>");
  ...
  void Events_Show (javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sEventsErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException  {
    ...
    if ( ! psearch.equals("") ) { 
      hasParam = true;
      sWhere = "e.event_name like '%" + replace(psearch, "'", "''") + "%'" + " or " + "e.event_desc like '%" + replace(psearch, "'", "''") + "%'" + " or " + "e.presenter like '%" + replace(psearch, "'", "''") + "%'";}
  ...
  try {
    out.println("    <table style=\"style=\"border-style: outset; border-width: 2\"\">");
    out.println("     <tr>\n      <td style=\"background-color: #990000; text-align: Center; border-style: outset; border-width: 1\" colspan=\"5\"><a name=\"Events\"><font style=\"font-size: 12pt; color: #FFFFFF; font-weight: bold\">SVEC - Event Administration</font></a></td>\n     </tr>");
  ...
  try {
    ...
    while ( (iCounter < RecordsPerPage) && rs.next() ) {
      ...
      String fldevent_id= "Edit";

      out.println("     <tr>");
      
      out.print("      <td style=\"background-color: #FFFFEE; border-style: inset; border-width: 1\">"); out.print("<a href=\"EditEvent.jsp?"+transitParams+"event_id="+toURL((String) rsHash.get("e_event_id"))+"&\"><font style=\"font-size: 10pt; color: #000000\">"+toHTML(fldevent_id)+"</font></a>");
    ...
    if (iCounter == 0) {
      ...
      out.print("<a href=\"EditEvent.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #000000; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("</td>\n     </tr>");
    ...
    if ( !bNext && iPage == 1 ) {
      ...
      out.print("\n        <a href=\"EditEvent.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #000000; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("\n      </td>\n     </tr>");
