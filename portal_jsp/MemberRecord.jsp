...
<%!
  ...
  String FormAction(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAction, String sForm, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    ...
    try {
      ...
      String sPage = "";
      String sParams = "";
      String sActionFileName = "Account.jsp";
      String sWhere = " ";
      boolean bErr = false;
      long iCount = 0;
      ...
      case iupdateAction:
          ...
          sSQL = "update members set " +
                ...
                ",first_name=" + toSQL(fldfirst_name, adText) +
                ",last_name=" + toSQL(fldlast_name, adText) +
                ",email=" + toSQL(fldemail, adText) +
                ",address1=" + toSQL(fldaddress1, adText) +
                ",address2=" + toSQL(fldaddress2, adText) +
                ",address3=" + toSQL(fldaddress3, adText) +
                ",city=" + toSQL(fldcity, adText) +
                ",state_id=" + toSQL(fldstate_id, adText) +
                ",zip=" + toSQL(fldzip, adText) +
                ",country_id=" + toSQL(fldcountry_id, adNumber) +
                ",phone_day=" + toSQL(fldphone_day, adText) +
                ",phone_evn=" + toSQL(fldphone_evn, adText) +
  ...
  void Form_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sFormErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    try {
      ...
      out.println("     <tr>\n      <td style=\"background-color: #990000; text-align: Center; border-style: outset; border-width: 1\" colspan=\"2\"><font style=\"font-size: 12pt; color: #FFFFFF; font-weight: bold\">Registration</font></td>\n     </tr>");
      if ( ! sFormErr.equals("")) {
      ...
      out.print("     <tr>\n      <td style=\"background-color: #FFCC66; border-style: inset; border-width: 1\"><font style=\"font-size: 10pt; color: #000000\">Email*</font></td><td style=\"background-color: #FFFFEE; border-style: inset; border-width: 1\">"); out.print("<input type=\"text\"  name=\"email\" maxlength=\"20\" value=\""+toHTML(fldemail)+"\" size=\"20\">");
      ...
      out.print("     <tr>\n      <td style=\"background-color: #FFCC66; border-style: inset; border-width: 1\"><font style=\"font-size: 10pt; color: #000000\">City</font></td><td style=\"background-color: #FFFFEE; border-style: inset; border-width: 1\">"); out.print("<input type=\"text\"  name=\"city\" maxlength=\"\" value=\""+toHTML(fldcity)+"\" size=\"\">");
      ...
      out.print("     <tr>\n      <td style=\"background-color: #FFCC66; border-style: inset; border-width: 1\"><font style=\"font-size: 10pt; color: #000000\">Zip</font></td><td style=\"background-color: #FFFFEE; border-style: inset; border-width: 1\">"); out.print("<input type=\"text\"  name=\"zip\" maxlength=\"\" value=\""+toHTML(fldzip)+"\" size=\"\">");
      ...
      if ( bPK && ! (sAction.equals("insert") && "Form".equals(sForm))) {
        out.print("<input type=\"submit\" value=\"Update\" onclick=\"document.Form.FormAction.value = 'update';\">");
