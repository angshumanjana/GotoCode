...
<%!
  ...
  void Admin_Show (javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sAdminErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    try {
      ...
      out.println("     <tr>\n      <td  align=\"center\" bgcolor=\"#0033CC\"><font style=\"font-size: 12pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Administration</font></td>\n     </tr>");
      out.print("     <tr>");
      // Set URLs
      
      String fldField1 = "AdminEventsGrid.jsp";
      String fldField2 = "AdminUsersGrid.jsp";
      String fldField3 = "AdminCategoriesGrid.jsp";
      // Show fields
      
      out.print("\n      <td ><a href=\""+fldField1+"\"><font style=\"font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica\">Events</font></a></td>\n\n      </tr>\n\n      <tr>");
      out.print("\n      <td ><a href=\""+fldField2+"\"><font style=\"font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica\">Users</font></a></td>\n\n      </tr>\n\n      <tr>");
      out.print("\n      <td ><a href=\""+fldField3+"\"><font style=\"font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica\">Categories</font></a></td>");
    ...
    try {
      ...
      switch (iAction) {
        case iloginAction: {
          ...
          rs = openrs( stat, "select user_id from users where user_login =" + toSQL(sLogin, adText) + " and user_password=" + toSQL(sPassword, adText));
  ...
  void Login_Show(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response, javax.servlet.http.HttpSession session, javax.servlet.jsp.JspWriter out, String sLoginErr, String sForm, String sAction, java.sql.Connection conn, java.sql.Statement stat) throws java.io.IOException {
    try {
      ...
      out.println("    <table border=\"0\" cellspacing=\"1\" cellpadding=\"2\" border=1>");
      out.println("     <tr>\n      <td align=\"center\" bgcolor=\"#0033CC\" colspan=\"2\"><font style=\"font-size: 12pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Login</font></td>\n     </tr>");
      ...
      if ( session.getAttribute("UserID") == null || ((String) session.getAttribute("UserID")).compareTo("") == 0 ) {
        // User did not login
        out.println("     <tr>\n      <td bgcolor=\"#0066FF\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica\">Login</font></td><td ><input type=\"text\" name=\"Login\" maxlength=\"50\" value=\""+toHTML(getParam( request, "Login"))+"\"></td>\n     </tr>");
        out.println("     <tr>\n      <td bgcolor=\"#0066FF\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica\">Password</font></td><td ><input type=\"password\" name=\"Password\" maxlength=\"50\"></td>\n     </tr>");
        ...
        // User logged in
        String sUserID = dLookUp( stat, "users", "user_login", "user_id =" + session.getAttribute("UserID"));
