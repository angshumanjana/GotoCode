...
static final String sFileName = "AdminCategoriesGrid.jsp";
...
<%!
  ...
  String tableHeader = "";
      tableHeader = "     <tr>\n      <td bgcolor=\"#0066FF\"><a href=\""+sFileName+"?"+formParams+"Formcategories_Sorting=1&Formcategories_Sorted="+sSorted+"&\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Name</font></a></td>\n     </tr>";
  
  
  try {
    out.println("    <table border=\"0\" cellspacing=\"1\" cellpadding=\"2\">");
    out.println("     <tr>\n      <td align=\"center\" bgcolor=\"#0033CC\" colspan=\"1\"><a name=\"categories\"><font style=\"font-size: 12pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Categories</font></a></td>\n     </tr>");
  ...
  try {
    ...
    while ( (iCounter < RecordsPerPage) && rs.next() ) {
      ...
      out.print("      <td >"); out.print("<a href=\"AdminCategoriesRecord.jsp?"+transitParams+"category_id="+toURL((String) rsHash.get("c_category_id"))+"&\"><font style=\"font-size: 10pt; color: #000000; font-family: Arial, Tahoma, Verdana, Helvetica\">"+toHTML(fldcategory_desc)+"</font></a>");
    ...
    if (iCounter == 0) {
      ...
      out.print("     <tr>\n      <td colspan=\"1\" bgcolor=\"#0066FF\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">");
      out.print("<a href=\"AdminCategoriesRecord.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("</td>\n     </tr>");
    ...
    if ( !bNext && iPage == 1 ) {
      ...
      out.print("     <tr>\n      <td colspan=\"1\" bgcolor=\"#0066FF\">\n       <font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">");
      out.print("\n        <a href=\"AdminCategoriesRecord.jsp?"+formParams+"\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Insert</font></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
      out.println("\n      </td>\n     </tr>");
      ...
      if ( iPage == 1 ) {
        ...
        out.print("\n       <a href=\""+sFileName+"?"+formParams+sSortParams+"Formcategories_Page="+(iPage - 1)+"#Form\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Previous</font></a>");
      }
      ...
      if (!bNext) { 
        ...
        out.print("\n       <a href=\""+sFileName+"?"+formParams+sSortParams+"Formcategories_Page="+(iPage + 1)+"#Form\"><font style=\"font-size: 10pt; color: #FFFFFF; font-family: Arial, Tahoma, Verdana, Helvetica; font-weight: bold\">Next</font></a><br>");
      }
